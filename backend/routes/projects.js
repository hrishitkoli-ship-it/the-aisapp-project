...
router.post('/', humanSensitiveLimiter, requireDeviceSecret, async (req, res, next) => {
  try {
...
router.post('/:projectId/regenerate-token', humanSensitiveLimiter, requireDeviceSecret, async (req, res, next) => {
  try {
...
router.delete('/:projectId', humanSensitiveLimiter, requireDeviceSecret, async (req, res, next) => {
  try {
    const { projectId } = req.params;
    let project;
    try {
